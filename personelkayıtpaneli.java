...
import GUİ.action.personelkayıtaction;
 ...
 * @author EXCALIBUR
 */
public class personelkayıtpaneli implements CustomPanel{
    ...
    public JButton getKaydol() throws IOException {
        if(this.kaydol==null){
            ...
            this.kaydol.addActionListener(new personelkayıtaction(this));
    ...
    public JLabel getBaşlık() {
        if(this.başlık == null){
            this.başlık = new JLabel("PERSONEL KAYIT EKRANI");
