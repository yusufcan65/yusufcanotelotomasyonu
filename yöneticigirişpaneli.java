...
public class yöneticigirişpaneli implements CustomPanel{
    ...
    public JButton getKayıt() throws IOException {
        if(this.kayıt == null){
            ...
            this.kayıt.addActionListener(new yöneticiaction(this));
        }
        return kayıt;
    }
    ...
    public JButton getGiriş() throws IOException {
        if(this.giriş == null){
            ...
            this.giriş.addActionListener(new yöneticiaction(this));
        }
        return giriş;
    }
    ...
    public JLabel getBaşlık() {
        if(this.başlık == null){
            this.başlık = new JLabel("YÖNETİCİ GİRİŞ EKRANI");
    ...
    public JPanel getPanel() {
        if(this.panel == null){
            ...
            try {
                ...
                Logger.getLogger(yöneticigirişpaneli.class.getName()).log(Level.SEVERE, null, ex);
            }
            try {
