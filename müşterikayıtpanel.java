...
import GUİ.action.müşterikayıtaction;
 ...
 * @author EXCALIBUR
 */
public class müşterikayıtpanel implements CustomPanel{
    ...
    public JButton getKaydol() throws IOException {
        if(this.kaydol==null){
            ...
            this.kaydol.addActionListener(new müşterikayıtaction(this));
    ...
    public JLabel getBaşlık() {
        if(this.başlık == null){
            this.başlık = new JLabel("MÜŞTERİ KAYIT EKRANI");
